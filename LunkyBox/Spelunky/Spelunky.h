...
namespace Spelunky
{
	const DWORD FUNCTION_PLAYSOUND_OFFSET = 0x16660;
	const DWORD FUNCTION_SPAWNENTITY_OFFSET = 0x6FD10;

	const std::vector<DWORD> CAMERA_POSITION_X_OFFSETS = {0x138558, 0x0};
	const std::vector<DWORD> CAMERA_POSITION_Y_OFFSETS = {0x138558, 0x4};

	const std::vector<DWORD> TIME_TOTAL_MINUTES_OFFSETS = {0x138558, 0x30, 0x280, 0x52AC};
	const std::vector<DWORD> TIME_TOTAL_SECONDS_OFFSETS = {0x138558, 0x30, 0x280, 0x52B0};
	const std::vector<DWORD> TIME_TOTAL_MILLISECONDS_OFFSETS = {0x138558, 0x30, 0x280, 0x52B7};

	const std::vector<DWORD> TIME_STAGE_MINUTES_OFFSETS = {0x138558, 0x30, 0x280, 0x52BC};
	const std::vector<DWORD> TIME_STAGE_SECONDS_OFFSETS = {0x138558, 0x30, 0x280, 0x52C0};
	const std::vector<DWORD> TIME_STAGE_MILLISECONDS_OFFSETS = {0x138558, 0x30, 0x280, 0x52C7};

	const std::vector<DWORD> GAME_IPR0D0J2V0_OFFSETS = {0x1384B4, 0x440629};
